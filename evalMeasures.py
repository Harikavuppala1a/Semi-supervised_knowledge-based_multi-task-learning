...
def insights_results_lab(pred_vals, true_vals, train_labels, dyn_fname_part, out_fold,num_runs,NUM_CLASSES,FOR_LMAP):
	...
	for i in range(num_runs):
		class_ind = 0
		TP, FP, FN = components_F(pred_vals[i], true_vals[i], NUM_CLASSES)
...
def calc_metrics_print(pred_vals, true_vals, metr_dict,NUM_CLASSES):
